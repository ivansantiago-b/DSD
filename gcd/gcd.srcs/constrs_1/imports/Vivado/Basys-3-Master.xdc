...
set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports {y_in[0]}]
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports {y_in[1]}]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {y_in[2]}]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {y_in[3]}]
